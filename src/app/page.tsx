...
// href points to public SEO landing pages. /tools/* and /blog/* are both
// indexable; /dashboard/* is Disallow'd in robots.txt and carries no link juice.
const FEATURE_KEYS = [
  { titleKey: 'feature.multiplatform', descKey: 'feature.multiplatform.desc', href: '/tools', icon: 'M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z' },
  { titleKey: 'feature.score', descKey: 'feature.score.desc', href: '/blog/viral-icerik-nasil-uretilir', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  { titleKey: 'feature.ab', descKey: 'feature.ab.desc', href: '/blog/viral-icerik-nasil-uretilir', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  { titleKey: 'feature.hooks', descKey: 'feature.hooks.desc', href: '/tools/hook-kutuphanesi', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
  { titleKey: 'feature.hashtags', descKey: 'feature.hashtags.desc', href: '/tools/hashtag-arac', icon: 'M7 20l4-16m2 16l4-16M6 9h14M4 15h14' },
  { titleKey: 'feature.competitor', descKey: 'feature.competitor.desc', href: '/blog/viral-icerik-nasil-uretilir', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
  { titleKey: 'feature.thread', descKey: 'feature.thread.desc', href: '/tools/tweet-uretici', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
  { titleKey: 'feature.urltopost', descKey: 'feature.urltopost.desc', href: '/blog/viral-icerik-nasil-uretilir', icon: 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1' },
  { titleKey: 'feature.bio', descKey: 'feature.bio.desc', href: '/tools/linkedin-post-yazici', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { titleKey: 'feature.reply', descKey: 'feature.reply.desc', href: '/tools/hook-kutuphanesi', icon: 'M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6' },
  { titleKey: 'feature.rewrite', descKey: 'feature.rewrite.desc', href: '/tools/instagram-caption-olusturucu', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
  { titleKey: 'feature.bulk', descKey: 'feature.bulk.desc', href: '/tools/tiktok-aciklama-olusturucu', icon: 'M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z' },
  { titleKey: 'feature.favorites', descKey: 'feature.favorites.desc', href: '/blog', icon: 'M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z' },
  { titleKey: 'feature.improver', descKey: 'feature.improver.desc', href: '/tools/hook-kutuphanesi', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
]
      ...
      <nav className="fixed top-0 w-full bg-white/80 dark:bg-[#13131a]/80 backdrop-blur-md z-50 border-b border-gray-100 dark:border-[#27272a]">
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex space-x-8 text-sm font-medium text-gray-500 dark:text-[#a1a1aa]">
            <a href="/tools" className="hover:text-black dark:hover:text-white transition-colors">{isEn ? 'Tools' : 'Araçlar'}</a>
