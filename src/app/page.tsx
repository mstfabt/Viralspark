...
// href points to SEO-indexable public pages (blog posts).
// Dashboard routes are Disallow'd in robots.txt, so they carry zero link juice.
const FEATURE_KEYS = [
  { titleKey: 'feature.multiplatform', descKey: 'feature.multiplatform.desc', href: '/blog/viral-icerik-nasil-uretilir', icon: 'M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z' },
  ...
  { titleKey: 'feature.hooks', descKey: 'feature.hooks.desc', href: '/blog/en-etkili-hook-cumleleri', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
  { titleKey: 'feature.hashtags', descKey: 'feature.hashtags.desc', href: '/blog/instagram-hashtag-stratejisi', icon: 'M7 20l4-16m2 16l4-16M6 9h14M4 15h14' },
  ...
  { titleKey: 'feature.thread', descKey: 'feature.thread.desc', href: '/blog/tweet-uretici-ai', icon: 'M4 6h16M4 10h16M4 14h16M4 18h16' },
  ...
  { titleKey: 'feature.bio', descKey: 'feature.bio.desc', href: '/blog/linkedin-post-yazma-rehberi', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
  { titleKey: 'feature.reply', descKey: 'feature.reply.desc', href: '/blog/en-etkili-hook-cumleleri', icon: 'M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6' },
  { titleKey: 'feature.rewrite', descKey: 'feature.rewrite.desc', href: '/blog/instagram-caption-olusturucu-ai', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
  { titleKey: 'feature.bulk', descKey: 'feature.bulk.desc', href: '/blog/tiktok-aciklama-yazma', icon: 'M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z' },
  ...
  { titleKey: 'feature.improver', descKey: 'feature.improver.desc', href: '/blog/en-etkili-hook-cumleleri', icon: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
]
